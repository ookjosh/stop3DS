/*
  Generated using the unix utility xxd
  xxd -i default_font.bin >> default_font.h

  Generates header files from all kinds of things.
*/

unsigned char default_font_bin[] = {
...
unsigned int default_font_bin_len = 2048;

// Number of bytes per glyph
unsigned int glyph_len = 8;

// gets offset to number glyph (0-9)
int int_to_font(int number) {
  return number + 48;
}